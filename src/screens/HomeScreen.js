      ...
      >
        <ModalContent style={{width:'100%', height: 400}}>
          <View style={{marginBottom: 8}}>
            ...
            <Text style={{fontSize: 16, marginTop: 5, color: 'gray'}}>Select a delivery location to see product availability and delivery options</Text>
          </View>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            ...
            <Pressable style={styles.modalButton} onPress={() => {
              ...
              <Text style={styles.modalbuttonText}>Add an Address or Pick-up point</Text>
            </Pressable>
          </ScrollView>
          ...
          <View style={{flexDirection: 'column', gap: 7, marginBottom: 30}}>
            <View style={{flexDirection: 'row', alignItems:"center", gap: 5}}>
              ...
              <Text style={{color: '#0066b2', fontWeight: 400}}>Enter a country code</Text>
            </View>
            <View style={{flexDirection: 'row', alignItems:"center", gap: 5}}>
            ...
            <View style={{flexDirection: 'row', alignItems:"center", gap: 5}}>
              ...
              <Text style={{color: '#0066b2', fontWeight: 400}}>Deliver outside Pakistan</Text>
            </View>
          </View>
